IMAGE_NAME=goafabric/backstage:1.0.3-SNAPSHOT
...
docker run --pull=always --rm -it -p 3000:7007 -e AUTH_GITHUB_CLIENT_ID=$AUTH_GITHUB_CLIENT_ID -e AUTH_GITHUB_CLIENT_SECRET=$AUTH_GITHUB_CLIENT_SECRET goafabric/backstage:1.0.3-SNAPSHOT
